...
public class absadvanced extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_absadvanced);
    ...
    public void openDialog2()
    {
        ...
        AlertDialog.Builder builder= new AlertDialog.Builder(absadvanced.this);
